...
contract CanonicalGovernorTest is BaseGovernorTest {
    ...
    function testVoteRevision() public {
        ...
        governorToken.mint(STAKEHOLDER_PRIMARY, STAKEHOLDER_MINOR);
        ...
        require(againstVotes == STAKEHOLDER_MAJOR + STAKEHOLDER_MINOR);
        require(forVotes == 0);
    }
    ...
    function testDelegatedVoteRevision() public {
        ...
        (, uint signalledForVotes,) = governor.getTally(proposalId);
        require(signalledForVotes == STAKEHOLDER_MINOR);
        /* -------------------------------- */
        ...
        (, uint committedDelegateForVotes,) = governor.getTally(proposalId);
        require(committedDelegateForVotes == STAKEHOLDER_MINOR * 2);
    ...
    function testDelegatedVoteRecommit() public {
        ...
        (, uint updatedForVotes,) = governor.getTally(proposalId);
        require(updatedForVotes == STAKEHOLDER_MINOR * 3);
